...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Compatibility wrapper for unified CLEVR static training.")
...
def main() -> None:
    ...
    run_main(argv=argv, default_mode="train", default_dataset="clevr")
